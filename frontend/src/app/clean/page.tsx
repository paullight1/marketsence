...
import { API_BASE_URL, MAX_CSV_UPLOAD_BYTES, fetchJson } from "@/lib/api";
...
export default function CleanCsvPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      setResult(await fetchJson<CleanCsvResult>("/api/ingest/clean-csv", { method: "POST", body: formData }));
    } catch (caught) {
